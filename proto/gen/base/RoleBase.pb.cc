...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_base_2fRoleBase_2eproto);
}
...
void protobuf_AddDesc_base_2fRoleBase_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\023base/RoleBase.proto\022\004base\"\027\n\010RoleBase\022"
    "\013\n\003uid\030\001 \002(\004", 52);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "base/RoleBase.proto", &protobuf_RegisterTypes);
  RoleBase::default_instance_ = new RoleBase();
  RoleBase::default_instance_->InitAsDefaultInstance();
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_base_2fRoleBase_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_base_2fRoleBase_2eproto {
  StaticDescriptorInitializer_base_2fRoleBase_2eproto() {
    protobuf_AddDesc_base_2fRoleBase_2eproto();
  }
} static_descriptor_initializer_base_2fRoleBase_2eproto_;
...
const RoleBase& RoleBase::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_base_2fRoleBase_2eproto();
