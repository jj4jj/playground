...
// source: base/Role.proto

#define INTERNAL_SUPPRESS_PROTOBUF_FIELD_DEPRECATION
#include "base/Role.pb.h"
...
void protobuf_AssignDesc_base_2fRole_2eproto() {
  protobuf_AddDesc_base_2fRole_2eproto();
  ...
  static const int RoleBase_offsets_[1] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(RoleBase, uid_),
  };
...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_base_2fRole_2eproto);
}
...
void protobuf_ShutdownFile_base_2fRole_2eproto() {
  delete RoleBase::default_instance_;
  delete RoleBase_reflection_;
}

void protobuf_AddDesc_base_2fRole_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\017base/Role.proto\022\004base\"\027\n\010RoleBase\022\013\n\003u"
    "id\030\001 \002(\004", 48);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "base/Role.proto", &protobuf_RegisterTypes);
  RoleBase::default_instance_ = new RoleBase();
  RoleBase::default_instance_->InitAsDefaultInstance();
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_base_2fRole_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_base_2fRole_2eproto {
  StaticDescriptorInitializer_base_2fRole_2eproto() {
    protobuf_AddDesc_base_2fRole_2eproto();
  }
} static_descriptor_initializer_base_2fRole_2eproto_;

// ===================================================================

#ifndef _MSC_VER
const int RoleBase::kUidFieldNumber;
#endif  // !_MSC_VER

RoleBase::RoleBase()
  : ::google::protobuf::Message() {
  SharedCtor();
  // @@protoc_insertion_point(constructor:base.RoleBase)
}
...
RoleBase::RoleBase(const RoleBase& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:base.RoleBase)
}
...
RoleBase::~RoleBase() {
  // @@protoc_insertion_point(destructor:base.RoleBase)
  SharedDtor();
}
...
const RoleBase& RoleBase::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_base_2fRole_2eproto();
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:base.RoleBase)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:base.RoleBase)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:base.RoleBase)
  return false;
#undef DO_
}
...
void RoleBase::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:base.RoleBase)
  // required uint64 uid = 1;
  if (has_uid()) {
  ...
  // @@protoc_insertion_point(serialize_end:base.RoleBase)
}

::google::protobuf::uint8* RoleBase::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:base.RoleBase)
  // required uint64 uid = 1;
  if (has_uid()) {
  ...
  // @@protoc_insertion_point(serialize_to_array_end:base.RoleBase)
  return target;
}
